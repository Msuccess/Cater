...
<head>
    ...
    <title>Login Page - PERBTOCOL</title>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                <form role="form" action = "login.php" method = "POST">
                                                    ...
                                                    <button type="submit" name="login" class="btn btn-primary float-left btn-inline">Login</button>
                                             <a href="#" class="btn btn-outline-primary float-right btn-inline">Clear</a>
                                                </form>
                                            </div>
                                        </div>
